...
export default function Footer() {
  ...
  return (
    ...
    >
      <div className="z-[2] grid gap-y-12 bg-black px-4 pt-20 lg:gap-y-20 lg:px-16 lg:pt-24">
        <div className="grid gap-y-12 bg-black lg:grid-cols-12 lg:gap-5">
          <nav aria-label="nav More info" className="col-span-full row-span-1 row-start-1 grid gap-y-6 lg:col-span-5 lg:col-start-1">
            <h3 className="text-xl font-bold uppercase text-white/50">More info</h3>
          ...
          <nav aria-label="nav Media" className="col-span-full row-span-1 row-start-2 grid items-start gap-y-6 justify-self-start lg:col-span-5 lg:col-start-6 lg:w-full lg:justify-self-start lg:row-start-1">
            <h3 className="text-xl font-bold uppercase text-white/50">Social</h3>
      ...
      <div className="sticky bottom-0 z-0 grid w-full gap-y-8 px-4 pb-20 lg:px-16 lg:pb-10 bg-black">
        <div className="col-span-full row-span-1 row-start-1 h-fit w-16 self-start justify-self-start overflow-hidden lg:row-span-full lg:w-24">
          <svg className="h-full w-full" xmlns="http://www.w3.org/2000/svg" width="93" height="92" viewBox="0 0 93 92" fill="none">
        ...
        <div className="col-span-full row-span-1 row-start-1 w-full max-w-xs self-start justify-self-end overflow-hidden lg:row-span-full lg:max-w-6xl">
            <span className="sr-only">Siloir</span>
            <svg className="h-full w-full" viewBox="0 0 1480 430" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M154.409 0C68.3297 0 0 64.1053 0 160.932C0 257.758 68.3297 321.864 154.409 321.864C240.489 321.864 309.254 257.766 309.254 160.932C309.254 64.0972 240.925 0 154.409 0ZM207.522 306.043C152.642 325.988 84.4661 277.188 55.2511 197.052C26.0361 116.909 46.844 35.7743 101.732 15.829C156.62 -4.11634 224.788 44.6836 254.003 124.819C283.218 204.955 262.41 286.089 207.522 306.035V306.043Z" fill="white"></path>
              <path d="M324.027 6.21931C364.239 6.21931 368.499 10.9479 368.499 38.3444V283.053C368.499 309.507 363.287 315.17 324.027 315.17V321.316H461.429V315.17C421.685 315.17 416.481 309.507 416.481 283.053V160.707H486.118C498.18 160.707 526.83 178.977 543.273 204.045H551.349L492.362 102.095H484.488C491.023 112.849 513.711 154.238 475.976 154.238H416.497C416.497 153.699 416.489 80.4181 416.505 79.9267H416.481C415.747 37.1925 440.048 5.9857 490.854 6.22736C541.675 6.00987 565.904 37.1764 565.202 79.8703H571.35V0.0810547H324.027V6.21931Z" fill="white"></path>
              <path d="M770.183 204.174C808.87 250.404 869.801 315.299 827.54 315.299H737.66C697.916 315.299 692.712 309.636 692.712 283.182V38.4734C692.712 12.0193 697.916 6.35627 737.66 6.35627V0.209961H600.259V6.35627C639.527 6.35627 644.739 12.0193 644.739 38.4734V283.182C644.739 309.636 639.527 315.299 600.259 315.299V321.453H889.254V315.323L778.163 204.174H770.175H770.183Z" fill="white"></path>
              <path d="M979.222 108.234C987.533 108.234 1003.5 108.387 1019.3 108.371C1030.76 108.362 1037.03 119.237 1029.66 128.002C1009.59 151.854 984.16 181.893 969.581 199.518C962.828 207.549 954.122 203.836 946.99 198.068C890.23 152.2 889.802 79.975 889.802 79.975C889.802 37.2731 911.361 6.27571 965.256 6.27571H979.23V0.145508H965.256C896.733 0.161619 841.829 1.99021 841.829 79.9831C841.829 79.9831 841.829 162.986 920.139 221.38C1039.32 308.597 1084.23 430.001 1084.23 430.001H1092.22C1062.3 338.869 1018.08 285.244 976.56 233.995C968.314 223.813 968.548 210.304 977.609 199.526C1007.57 163.913 1048.92 108.242 1092.22 108.242V102.103H979.23V108.242L979.222 108.234Z" fill="white"></path>
              <path d="M1356.57 0.145508V0.17773H1298.1V6.28376H1356.57C1410.48 6.28376 1432.14 37.2811 1432.14 79.9831C1432.14 79.9831 1431.6 152.208 1374.84 198.076C1367.71 203.844 1358.99 207.557 1352.25 199.526C1339.91 184.607 1202.73 21.5811 1184.66 0.145508H1176.55H1092.21V6.29182C1131.48 6.29182 1136.68 11.9548 1136.68 38.4089V283.117C1136.68 309.572 1131.47 315.234 1092.21 315.234V321.381H1229.61V315.234C1189.88 315.234 1184.66 309.572 1184.66 283.117V115.177V38.3042C1184.66 28.6215 1196.77 24.1991 1203 31.6182C1253.86 92.1146 1341.61 196.481 1344.22 199.518C1353.39 210.199 1353.51 223.805 1345.27 233.987C1303.75 285.236 1259.52 338.861 1229.61 429.992H1237.6C1237.6 429.992 1282.51 308.589 1401.69 221.372C1480 162.978 1480 79.975 1480 79.975C1480 1.99021 1425.09 0.161619 1356.57 0.145508Z" fill="white"></path>
            </svg>
        </div>
      </div>
    </footer>
